            ...
            >
              <Tabs.Item title="Burning Mining" class="text-orange-500 text-lg">
                <div className="max-w-screen-xl mx-auto font-jost m-24 lg:w-11/12 rounded-2xl border border-orange-500 bg-gradient-to-b from-orange-950 to-neutral-950">
                  ...
                  <div className="p-8 flex flex-row flex-wrap justify-around border-y border-orange-500">
                    <div className="py-4">
                      <p className="text-slate-50">
                        Total SHICOD for Burning Mining
                      </p>
                    ...
                    <div className=" py-4">
                      <p className="text-slate-50">Total SHICOD Distributed</p>
                      <p className="text-orange-500 font-bold text-lg">
                        305454.500
                      </p>
                    </div>
                  ...
                  <p className="text-slate-50 p-4 text-left">
                    ...
                    <br></br>
                    2. SHIBAI’s burning and SHICOD’s mining will be completed at
                    24:00 (UTC) every day. Participants will obtain SHICOD
                    ...
                    4. When there is a balance of SHICOD in the account, it can
              ...
              <Tabs.Item title="Trade Mining" className="text-orange-500">
                <div className="max-w-screen-xl mx-auto font-jost m-24 lg:w-11/12 rounded-2xl border border-orange-500 bg-gradient-to-b from-orange-950 to-neutral-950">
                  ...
                  <p className="text-slate-50 p-4 text-left">
                    1. You are eligible to take part in SHICOD's rewards
                    distribution if you make an SHIBAI purchase on Camelot
                    valued more than 500$ in a single transaction.
                    <br></br>
                    2. Today's estimated reward amount is constantly changing,
                    and it is related to how much SHIBAI you purchase and how
                    much the entire transaction amount for purchasing SHIBAI is.
                    <br></br>
                    3. The SHIBAI you trade can only be used to share the SHICOD
                    ...
                    fluctuating. When purchasing SHIBAI, please ensure that you
                    ...
                    6. Only purchases made in Camelot v2 ETH/SHIBAI will be
